public class LanguageButton : Gtk.MenuButton {
    ...
    public LanguageButton () {
        ...
        menu_list.add (create_lang_button ("Russian + English", "eng+rus", popover)) ;
    ...
    private void update_ui_label (string lang_code) {
        if (lang_code == "eng+rus" || lang_code == "rus+eng") {
            lang_label.label = "RU+" ;
        } else if (lang_code.contains ("rus")) {
            lang_label.label = "RU" ;
    ...
    private static string load_config () {
        ...
        if (sys_lang.contains ("ru") || sys_lang.contains ("RU")) return "eng+rus" ;
